...
# This part is image labels setting start 
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Users\HP\Documents\Python_Test_Projects\Images_GUI\web.png")
        ...
        det_img_btn=Image.open(r"C:\Users\HP\Documents\Python_Test_Projects\Images_GUI\fb.png")
        ...
        att_img_btn=Image.open(r"C:\Users\HP\Documents\Python_Test_Projects\Images_GUI\yt.png")
        ...
        hlp_img_btn=Image.open(r"C:\Users\HP\Documents\Python_Test_Projects\Images_GUI\gmail.png")
    ...
    def website(self):
        self.new = 1
        self.url = "https://gpkashipur.in/"
        webbrowser.open(self.url,new=self.new)
    
    def facebook(self):
        self.new = 1
        self.url = "https://www.facebook.com/profile.php?id=100063889576332"
        webbrowser.open(self.url,new=self.new)
    
    def youtube(self):
        self.new = 1
        self.url = "https://youtube.com/@governmentpolytechnickas-ms3dl"
        webbrowser.open(self.url,new=self.new)
    
    def gmail(self):
        self.new = 1
        self.url = "csedeptgpk@gmail.com"
        webbrowser.open(self.url,new=self.new)
