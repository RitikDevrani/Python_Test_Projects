...
class Student:
    ...
    # This part is image labels setting start 
        ...
        f_lb1.place(x=0,y=0,width=1530,height=130)
         ...
         # backgorund image 
        bg1=Image.open(r"C:\Users\HP\Documents\Python_Test_Projects\Images_GUI\bg3.jpg")
        ...
        current_course_frame.place(x=10,y=5,width=715,height=150)
        ...
        dep_combo["values"]=("Select Department","CSE","IT","Electronics")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","Degree","Diploma","Other Course")
        cou_combo.current(0)
        ...
        year_combo["values"]=("Select Year","2021-24","2022-25","2023-26","2024-27","2025-29")
        ...
        class_Student_frame.place(x=10,y=160,width=715,height=230)
        ...
        #Class Didvision
        student_Divi_label = Label(class_Student_frame,text="Class Divi:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        student_Divi_label.grid(row=1,column=0,padx=5,pady=5,sticky=W)

        Divi_combo=ttk.Combobox(class_Student_frame,textvariable=self.var_Divi,width=13,font=("verdana",12,"bold"),state="readonly")
        Divi_combo["values"]=("Morning","Evening")
        Divi_combo.current(0)
        Divi_combo.grid(row=1,column=1,padx=5,pady=5,sticky=W)
        ...
        btn_frame.place(x=10,y=390,width=715,height=60)
        ...
        right_frame.place(x=745,y=10,width=765,height=480)
        ...
        search_frame.place(x=10,y=5,width=740,height=80)
        ...
        table_frame.place(x=10,y=90,width=740,height=360)
        ...
        #create table 
        self.student_table = ttk.Treeview(table_frame,column=("ID","Name","Dep","Course","Year","Sem","Divi","Gender","DOB","Mob-No","Address","Roll-No","Email","Teacher","Photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.student_table.heading("Divi",text="Divi")
...
# ==================Function Decleration==============================
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_Divi.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
            messagebox.showerror("Error","Please Fill All Fields are Required!",parent=self.root)
        else:
            try:
                conn = mysql.connector.connect(username='root', password='Ritik@2002',host='localhost',database='face_recognition',port=3306)
                mycursor = conn.cursor()
                mycursor.execute("insert into student_table values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(
                self.var_std_id.get(),
        ...
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_Divi.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
            ...
            try:
                ...
                if Update > 0:
                    conn = mysql.connector.connect(username='root', password='Ritik@2002',host='localhost',database='face_recognition',port=3306)
                    mycursor = conn.cursor()
                    mycursor.execute("update student_table set Name=%s,Department=%s,Course=%s,Year=%s,Semester=%s,Divi=%s,Gender=%s,DOB=%s,Mobile_No=%s,Address=%s,Roll_No=%s,Email=%s,Teacher_Name=%s,PhotoSample=%s where Student_ID=%s",( 
                    self.var_std_name.get(),
                    self.var_dep.get(),
                    self.var_course.get(),
                    self.var_year.get(),
    ...
    def search_data(self):
        if self.var_search.get()=="" or self.var_searchTX.get()=="Select":
            ...
            try:
                ...
                sql = "SELECT Student_ID,Name,Department,Course,Year,Semester,Divi,Gender,DOB,Mobile_No,Address,Roll_No,Email,Teacher_Name,PhotoSample FROM student_table where Roll_No='" +str(self.var_search.get()) + "'" 
                my_cursor.execute(sql)
                # my_cursor.execute("select * from student_table where Roll_No= " +str(self.var_search.get())+" "+str(self.var_searchTX.get())+"")
